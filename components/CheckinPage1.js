    ...
    <>
      ...
      <div className="w-screen flex flex-col justify-center items-center mt-6">
        <div className="text-center pt-12">
          <p className="text-2xl px-6 text-[#A79AF8] font-bold">
        ...
        <div className="flex text-center w-full justify-center items-center gap-5 mt-8 mb-8">
          <button
            ...
            className={`${
              answer1 == "Yes" ? "border-[#A79AF8] border-[1.5px]" : null
            } w-24 h-16 px-2 py-2 bg-[#FFFFFF] rounded-[10px] text-black shadow-lg`}
          >
            <div className="flex flex-row justify-center items-center gap-1">
              <CheckCircleIcon className="w-6 text-[#B0CB93]" /> Yes
            </div>
          </button>
          <button
            onClick={(e) => {
            ...
            className={`${
              answer1 == "No" ? "border-[#A79AF8] border-[1.5px]" : null
            } w-24 h-16 px-2 py-2 bg-[#FFFFFF] rounded-[10px] text-black shadow-lg`}
          >
            <div className="flex flex-row justify-center items-center gap-1">
              <XCircleIcon className="w-6 text-[#EE7B69]" /> No
            </div>
          </button>
        </div>
      </div>
      <footer className="z-10 flex justify-between px-4 py-4 pb-14 fixed bottom-0 left-0 right-0 bg-[#FFFFFF]">
        {answer1 ?
        <button onClick={nextPage} className="checkin-btn bg-[#A79AF8]">
          Next
        </button>
          :
        <button disabled={true} onClick={nextPage} className="checkin-btn bg-[#A79AF8] opacity-40">
          Next
        </button>}
      </footer>
    </>
